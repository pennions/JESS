    ...
    <section class="mx-3 column">
      ...
      <article class="card flex-layout two-columns justify-between gap-3">
        <div>
          ...
          <small>* you can also apply any text-color utility class</small>
        </div>
        <div>
          <p>Examples:</p>
        ...
        <pre
          class="border w-100"><code class="language-html">{{ coloured_icon_example }}</code></pre>
      </article>
    </section>
  </main>
</template>
